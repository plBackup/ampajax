        ...
        $.each(menu,function(i,e){
            ...
            $.each(sub_menu,function(i,e){
             ...
             /*  var li_item=[
                   ...
                   '<a href="#pane-sub-'+main_index+'-'+sub_index+'" role="tab" data-toggle="tab" data-show-header="'+e.show_page_header+'" data-href="'+ e.links+'" data-relocate="'+ e.re_locate+'" id="nav-'+main_index+'-'+sub_index+'">'+ e.name+'</a>',
                   '</li>',
               ];*/
                var li_item=[
                    '<li role="presentation" id="nav-tabs-item-'+main_index+'-'+sub_index+'">',
                ...
                $.each(e.sub_menu,function(i,e){
                    ...
                    var tri_item_li=[
                        '<li>',
                        '<a rel="'+e.target+'"   href="'+ e.links+'" id="tri-'+main_index+'-'+sub_index+'-'+tri_index+'" class="header-subnav-item" target="'+ e.target+'">'+ e.name+'</a>',
                        '</li>'
                    ];
